...
<html lang="en" dir="ltr">
  ...
  <!--  This set of code handles the header-->
   ...
   <div class="card-group">
    <div class="card">
    <img class="card-img-top img1" src="http://www.druzefoundation.com/wp-content/uploads/2015/11/who_are_we.png" alt="Card image cap">
    <div class="card-body">
    <h5 class="card-title"></h5>
    <p class="card-text">CommCourier stands for Community Courier. We are a start-up company geared towards providing connectivity between travelers and individuals who want to send an item in real-time. We believe that communal strength can help save money, time and live.</p>
      <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
    </div>
    </div>
    <div class="card">
    <img class="card-img-top img2" src="http://mirza-tech.com/images/whatwedo_banner.jpg" alt="Card image cap">
    <div class="card-body">
    <h5 class="card-title"></h5>
    <p class="card-text">Commcourier is a platform that connects verified travelers with verified senders wishing to send packages through the travelers.
    ...
    <div class="card">
    <img class="card-img-top img3" src="http://www.kre8iveminds.com/images/our-goal.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title"></h5>
      <p class="card-text">Our goal is to enable real-time courier services through the community as well as provide extra income for participants.</p>
      <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
    </div>
    </div>
    </div>
